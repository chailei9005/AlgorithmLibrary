...
|[N-Queens Problem](https://en.wikipedia.org/wiki/Eight_queens_puzzle)|[NQueen.h](./src/NQueen.h) [NQueen.cpp](./src/NQueen.cpp)|solve by [Hill Climbing Algorithm](https://en.wikipedia.org/wiki/Hill_climbing)|
